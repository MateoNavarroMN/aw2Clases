...
import { obtenerProductos, obtenerProductoID, eliminarProductoID, altaProducto, modificarProductoID } from './funciones.mjs'
...
// app.put('/api/v1/productos/:id', modificarProductoID)
